...
namelist/input/year,month,day,time_step,tz,phi,sigma,elev,press,Temp,delta_T
!--------------------------------------------------------------------------------
...
write(*,"(/,'year: ',I4.4,'   month: ',I2.2,'   day: ',I2.2)") year, month, day 

call sunrise_sunset(sunrise,sunset,transit)

open(unit=21,file='solar_trajectory.dat')

write(*,"(/,'# sunrise = ',2(I2.2,':'),I2.2)") sunrise(1),sunrise(2),sunrise(3)
write(*,"(/,'# transit = ',2(I2.2,':'),I2.2)") transit(1),transit(2),transit(3)
write(*,"(/,'# sunset  = ',2(I2.2,':'),I2.2,/)") sunset(1),sunset(2),sunset(3)

write(21,"(/,'# sunrise = ',2(I2.2,':'),I2.2)") sunrise(1),sunrise(2),sunrise(3)
write(21,"(/,'# transit = ',2(I2.2,':'),I2.2)") transit(1),transit(2),transit(3)
write(21,"(/,'# sunset  = ',2(I2.2,':'),I2.2,//)") sunset(1),sunset(2),sunset(3)
